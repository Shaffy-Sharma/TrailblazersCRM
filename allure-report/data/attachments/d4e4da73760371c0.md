...
- Name: tests\features\Call.feature.spec.js >> Calls Management in SuiteCRM >> Redirect to List View for search
- Location: .features-gen\tests\features\Call.feature.spec.js:16:7
...
Call log:
  ...
  - waiting for getByText('Calls', { exact: true }).first()
    14 × locator resolved to <span class="ng-star-inserted">Calls</span>
