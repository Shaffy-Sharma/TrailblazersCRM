...
Given('Import Contact: the user is logged into SuiteCRM', async ({ page }) => {
  await page.goto('https://suite8demo.suiteondemand.com/#/Login'); 
});

When('Import Contact: user enters {string} and {string} credentials to login', async ({ page }, username, password) => {
...
Given('Import Contact: the user navigates to the dashboard', async ({ page }) => {
